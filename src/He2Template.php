...
Class He2Template {
	 ...
	 * 			-'prefix' _string_: The first part of the view. If the view is add.html.php, the add would be
	 * the prefix. Default value is index
	 ...
	 * 			-'prefix' _string_: The first part of the template. The default value for the prefix is
	 * 'default'
	 * 			-'type' _string_: The
	 *
	 */
	...
	/**
	 * Takes the content from the output buffer, and runs it through the updateHeader function, This will
	 * replace
	...
	/**
	 * Displays the content in a view that will render in a template. Call this function once in the
	 * template folder.
	 *
	 * @return void
	 * @access public
	...
	/**
	 * Returns the header to be placed at the top of a template. The header contains tags that will be
	 * replaced
	 * at the end of output buffering with the site's title, meta descriptiong, keywords, and additional
	 * javascript
